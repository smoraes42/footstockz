...
// GET all teams with their aggregate market data (Index Fund)
...
// GET single team details and roster
...
// GET price history for a team (Aggregate index)
router.get("/:id/history", async (req, res) => {
    try {
        const teamId = req.params.id;
        
        // Strategy: 
        // 1. Find all players in the team
        // 2. Get their prices grouped by time intervals (e.g., 5 min)
        // 3. Sum them up
        // Improved: For simplicity and reactivity, we'll fetch player prices in a joined query
        // and group them by a time-bucket to get the aggregate index value over time.
