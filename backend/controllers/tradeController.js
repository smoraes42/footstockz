...
export const getDepthChart = (req, res) => {
    try {
...
export const marketBuy = async (req, res) => {
    try {
...
export const marketSell = async (req, res) => {
    try {
...
export const teamMarketBuy = async (req, res) => {
    try {
...
export const teamMarketSell = async (req, res) => {
    try {
...
export const getPlayerTradeHistory = async (req, res) => {
    try {
        const playerId = parseInt(req.params.playerId);
...
export const getTradeConfig = (req, res) => {
