        ...
        <div className={styles.container}>
            ...
            <main className={styles['main-content']}>
                ...
                <div className={styles['tabs-row']}>
                    ...
                    <button 
                        className={`${styles['activity-toggle-btn']} ${activeTab === 'activity' ? styles['activity-toggle-btn-active'] : ''}`}
                ...
                {loading ? (
                    ...
                    <div>
                        <div className={`glass-panel ${styles['table-panel']}`}>
                            {activeTab === 'activity' ? (
                                <>
                                <div className={styles['activity-header']} style={{ padding: '1.5rem', paddingBottom: '0.5rem' }}>
                                    <h2 className={styles['activity-title']} style={{ fontSize: '1.2rem' }}>Actividad Reciente</h2>
                                </div>
                                {loadingTrades ? (
                                    <div className={styles.loading} style={{ padding: '3rem' }}>Cargando actividad...</div>
                                ) : (
